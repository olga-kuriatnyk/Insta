...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // setting the description of the post
        // a button to launch the camera to take a picture
        // an ImageView to show the picture the user has taken
        // a button to save an send the post to our Parse server
        ...
        findViewById<Button>(R.id.takePicture_button).setOnClickListener {
